...
int EBuffer::PushBlockData()
{
	...
	return 1;
    if (PushULong(BB.Col) == 0)
	return 0;
    if (PushULong(BB.Row) == 0)
	return 0;
    if (PushULong(BE.Col) == 0)
	return 0;
    if (PushULong(BE.Row) == 0)
	return 0;
    if (PushULong(BlockMode) == 0)
	return 0;
    if (PushUChar(ucBlock) == 0)
	return 0;
    return 1;
}
...
int EBuffer::PushUData(void *data, int len)
{
	...
	N = US.Num;
	if ((BFI(this, BFI_UndoLimit) == -1) || (US.Undo)
	    || (US.Num < BFI(this, BFI_UndoLimit))) {
	    N++;
...
int EBuffer::Undo(int undo)
{
	...
	case ucDelLine:
	    ...
	    if (rc == 0)
		return 0;
	    if (GetUData(No, Pos, &data, Len) == 0)
		return 0;
	    if (InsLine(Line, 0) == 0)
		return 0;
	    if (InsText(Line, 0, Len, (char *)data) == 0)
		return 0;
	    Pos -= Len;
	    break;
	...
	case ucDelChars:
	    ...
	    if (rc == 0)
		return 0;
	    if (GetUData(No, Pos, &data, ACount) == 0)
		return 0;
	    if (InsChars(Line, Col, ACount, (char *)data) == 0)
		return 0;
	    Pos -= ACount;
	    break;
	...
	case ucPlaceUserBookmark:
		...
		if (RemoveUserBookmark((const char *)data) == 0)
		    return 0;
	    }
	    else {
		if (PlaceUserBookmark((const char *)data, EPoint(Line, Col))
		    == 0)
		    return 0;
	    }
	    break;
	...
	case ucRemoveUserBookmark:
	    ...
	    if (rc == 0)
		return 0;
	    if (PlaceUserBookmark((const char *)data, EPoint(Line, Col)) == 0)
		return 0;
	    break;
