...
{
    if (CvsIgnoreRegexpCount >= MAXREGEXP)
	return 0;
    if ((CvsIgnoreRegexp[CvsIgnoreRegexpCount] = RxCompile(regexp)) == NULL)
	return 0;
...
ECvsBase::ECvsBase(int createFlags, EModel ** ARoot,
