...
void MoveChar(PCell B, int Pos, int Width, const char CCh, TAttr Attr,
	      int Count)
{
    unsigned char *p = (unsigned char *)B;
...
void MoveMem(PCell B, int Pos, int Width, const char *Ch, TAttr Attr,
	     int Count)
{
    unsigned char *p = (unsigned char *)B;
...
void MoveStr(PCell B, int Pos, int Width, const char *Ch, TAttr Attr,
	     int MaxCount)
{
    unsigned char *p = (unsigned char *)B;
...
void MoveCStr(PCell B, int Pos, int Width, const char *Ch, TAttr A0, TAttr A1,
	      int MaxCount)
{
    unsigned char *p = (unsigned char *)B;
...
void MoveChar(PCell B, int Pos, int Width, const char Ch, TAttr Attr,
	      int Count)
{
    PCHAR_INFO p = (PCHAR_INFO) B;
...
void MoveBgAttr(PCell B, int Pos, int Width, TAttr Attr, int Count)
{
    ...
    for (p += Pos; Count > 0; Count--) {
	p->Attributes =
	    ((unsigned char)(p->Attributes & 0xf)) | ((unsigned char)Attr);
	p++;
    }
}
