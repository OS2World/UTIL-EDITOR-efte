/*
 *
 * $Id: ckfiles.cmd 1256 2008-10-23 14:06:46Z jbs $
 *
...
dummy_date_time   =  '-1'
in_file   =  'bld_eFTE2_wpidirs.txt'
out_file  =  'bld_eFTE2_wpidirs.in'
retval      = 0
                           ...
                           do
                              if file_reset = 0 then
                                 do
                                    ...
                                    call lineout out_file, '; Any desired edits should be done to BLD_eFTE2_WPIDIRS.TXT, instead.'
                                    call lineout out_file, ';'
                                 end
